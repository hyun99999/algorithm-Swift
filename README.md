...
|    문제                   |   난이도   |   풀이   |  날짜   |  알고리즘  |
| :----------------------: | :------: | :-------: |:-------:|:-------:|
|   [최소비용 구하기](https://www.acmicpc.net/problem/1916)       |   <img src="https://static.solved.ac/tier_small/11.svg" width ="15"> |   [🥇](https://github.com/hyun99999/algorithm-Swift/blob/master/Gold/최소비용 구하기.swift)    | `23.07.21`  | 다익스트라 |
