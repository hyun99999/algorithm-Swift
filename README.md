...
|    문제                   |   난이도   |   풀이   |  날짜   |  알고리즘  |
| :----------------------: | :------: | :-------: |:-------:|:-------:|
|   [N과 M(9)](https://www.acmicpc.net/problem/15663)       |   <img src="https://static.solved.ac/tier_small/10.svg" width ="15"> |   [🥈](https://github.com/hyun99999/algorithm-Swift/blob/master/Silver/N과%20M(9).swift)    | `23.07.23`  | 순열 |
