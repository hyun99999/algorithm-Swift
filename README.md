...
|    문제                   |   난이도   |   풀이   |  날짜   |  알고리즘  |
| :----------------------: | :------: | :-------: |:-------:|:-------:|
|   [파도반 수열](https://www.acmicpc.net/problem/9461)       |   <img src="https://static.solved.ac/tier_small/8.svg" width ="15"> |   [🥈](https://github.com/hyun99999/algorithm-Swift/blob/master/Silver/파도반%20수열.swift)    | `23.07.26`  |  |
